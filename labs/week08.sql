...
, pv_user_name           VARCHAR2 ) IS
  ...
  ( pv_account_number IN VARCHAR2) RETURN NUMBER IS 
...
BEGIN
  ...
  IF lv_member_id = 0 THEN  
     ...
     *  only when a member account does not exist.
     */
    INSERT INTO member (member_id,member_type, account_number, credit_card_number, credit_card_type, created_by, creation_date,last_updated_by,last_updated_date)
    VALUES (member_sl.NEXTVAL,lv_member_type, pv_account_number, pv_credit_card_number, lv_credit_card_type, lv_created_by, lv_current_date,lv_updated_by,lv_current_date)
    lv_member_id := member_sl.CURRVAL;
  END IF;

  /* Insert into contact table. */
 INSERT INTO contact (contact_id,member_id, contact_type, last_name, first_name ,middle_name,created_by, creation_date,last_updated_by,last_updated_date)
  VALUES (contact_sl.NEXTVAL,lv_member_id, lv_contact_type, pv_last_name, pv_first_name, pv_middle_name, lv_created_by, lv_current_date,lv_updated_by,lv_current_date);
  lv_contact_id := contact_sl.CURRVAL; 

  /* Insert into address table. */
 INSERT INTO address (address_id,contact_id,city, state_province, postal_code,created_by, creation_date,last_updated_by,last_updated_date)
  VALUES (addres_sl.NEXTVAL,lv_contact_id,lv_address_type, pv_city, pv_state_province, pv_postal_code, lv_created_by, lv_current_date,lv_updated_by,lv_current_date);
  lv_address_id :=addres_sl.CURRVAL;


  /* Insert into street_address table. */
    INSERT INTO street_address (street_address_id,address_id,line_number, street_address, created_by, creation_date,last_updated_by,last_updated_date)
  VALUES (street_address_ls.NEXTVAL,lv_address_id ,pv_street_address, lv_created_by, lv_current_date,lv_updated_by,lv_current_date);
  
  /* Insert into telephone table. */
  INSERT INTO telephone (telephone_id,contact_id,address_id,telephone_type,country_code,area_code,telephone_number, created_by, creation_date,last_updated_by,last_updated_date)
  VALUES (telephone_sl.NEXTVAL,lv_contact_id,lv_address_id,lv_telephone_type,pv_country_code,pv_area_code,pv_telephone_number,lv_created_by,lv_current_date,lv_updated_by,lv_current_date);
